...
document.addEventListener( 'DOMContentLoaded', function () {
    if ( is_vivaldi() ) {
        ...
        console.log(query_map.url + " " + query_map.filename);
        console.log("after");
//      query_map.url = query_map.url.replace('webp','jpg')
//      query_map.filename = query_map.filename.replace('webp','jpg')
        query_map.url = query_map.url.replace('webp','png')
        query_map.filename = query_map.filename.replace('webp','png')
        console.log(query_map.url + " " + query_map.filename);
