...
function download_image( info, tab ) {
    ...
    var img_url_orig = img_url.replace( /:\w*$/, '' ) + ':large',
        filename = get_filename_from_image_url( img_url_orig, link_url );
    
    img_url_orig = get_formatted_img_url( img_url_orig );
    //img_url_orig = img_url_orig.replace('webp','jpg');
    img_url_orig = img_url_orig.replace('webp','png');
    //filename = filename.replace('webp','jpg');
    filename = filename.replace('webp','png');
    //console.log(img_url_orig + " " + img_url + " " + filename);
